...
public class ItemController {
     ...
     */
    @GetMapping()
    public List<ItemDto> get(@RequestHeader(WebUserName.SHARER) Long userId) {
     ...
     */
    @GetMapping("/{itemId}")
    public ItemDto get(@RequestHeader(WebUserName.SHARER) long userId, @PathVariable Long itemId) {
     ...
     */
    @GetMapping("/search")
    public List<ItemDto> search(@RequestHeader(WebUserName.SHARER) long userId,
     ...
     */
    @PostMapping()
    public ItemDto create(@RequestHeader(WebUserName.SHARER) long userId,
    ...
    public CommentDto create(@RequestHeader(WebUserName.SHARER) long userId,
     ...
     */
    @PatchMapping("/{itemId}")
    public ItemDto update(@RequestHeader(WebUserName.SHARER) long userId,
